...
module.exports = {
  ...
  biddingCard: async function(app) {
    app.get('/ui_provider/biddingCard?:serviceID', async function(req, res) {
      let route = `GET /path1/path2/${req.params.serviceID}`;
      res.render('ui_provider/biddingCard.ejs');
    })
  },
  browseAuctions: async function(app) {
    app.get('/ui_provider/browseAuctions', async function(req, res) {
      //let route = `GET /path1/path2/${req.params.providerID}`;
      res.render('ui_provider/browseAuctions.ejs');
    })
  },
